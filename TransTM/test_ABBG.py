...
from pysot_toolkit.trackers.tracker_ABBG import Tracker
...
def main():
    ...
    net_path = '/mnt/TransT_M/models/TransTiouhsegm_ep0090.pth.tar'
    # net_path = '/home/cx/TransT/models/transt.pth'

    # create model
    net = NetWithBackbone(net_path=net_path, use_gpu=True)
    tracker = Tracker(name='TransTM_ABBG', net=net, mask=args.mask,
